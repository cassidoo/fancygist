	...
	return (
		...
		>
			<a
				...
				className="absolute left-0 top-1/2 -translate-y-1/2 text-gray-500 opacity-0 transition-opacity hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 focus-visible:opacity-100 group-hover:opacity-100"
			>
