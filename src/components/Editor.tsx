...
export default function Editor({ value, onChange }: EditorProps) {
  ...
  useEffect(() => { filteredCommandsRef.current = filteredCommands; });
  ...
  useEffect(() => { doInsertRef.current = doInsert; });
  ...
  return (
    <div ref={containerRef} className="h-full w-full overflow-auto bg-white relative">
      <CodeMirror
        ref={editorRef}
        value={value}
        minHeight="100%"
